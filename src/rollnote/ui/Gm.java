...
/** General MIDI program and percussion names (GM level 1). */
public final class Gm {
    ...
    /** GM percussion map: note number -> name (only the standard 35..81 range). */
    public static final String[] PERCUSSION = new String[128];
    static {
        String[] p = {
    ...
    public static String percussionName(int note) {
        String n = PERCUSSION[note];
        return n != null ? n : NoteName2.name(note) + " (" + note + ")";
    }
}
